...
function initLayer(data) {
    ...
    let layer1 = new VGEEarth.MapVLayer(viewer, dataSet, options);
    ...
    let layer2 = new VGEEarth.MapVLayer(viewer, dataSet, options);
