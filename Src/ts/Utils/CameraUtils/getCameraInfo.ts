...
function getCameraInfo() {
    ...
    cartographic = {
        longitude: Math.floor(Cesium.Math.toDegrees(cartographic.longitude) * 10_0000) / 10_0000,
        latitude: Math.floor(Cesium.Math.toDegrees(cartographic.latitude) * 10_0000) / 10_0000,
        height: Math.floor(cartographic.height * 10_0000) / 10_0000
    };
