 ...
 */
class PopupWindow2Decorator extends BaseDecorator {
    ...
    createDecorator() {
        ...
        <div class="popup3d2-container" v-if="show">
            <div class="popup3d2-header">
                ...
                <span class="popup3d2-close" title="关闭" id="${id}-close">×</span>
            </div>
