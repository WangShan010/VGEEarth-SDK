...
const EntityFactory = {
     ...
     */
    spaceDistanceLabel(startPoint, endPoint) {
     ...
     * @param type
     */
    async polygonCenterLabel(geoJson, type = '周长') {
     ...
     * @param pro
     */
    buildLabelByDegrees(position, text, pro = {}) {
        let param = {
     ...
     * @param positions
     */
    createLightingPolygon(positions) {
        return new Cesium.Entity({
            polyline: {
