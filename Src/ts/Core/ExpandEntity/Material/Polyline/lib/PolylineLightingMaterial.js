...
class PolylineLightingMaterial extends PolylineBaseMaterial {
    ...
    equals(other) {
        return this === other ||
            (other instanceof PolylineLightingMaterial && Cesium.Property.equals(this._color, other._color));
    }
    ;
    getType() {
...
if (window.Cesium) {
    Object.defineProperties(PolylineLightingMaterial.prototype, {
        color: Cesium.createPropertyDescriptor('color')
    });
}
export { PolylineLightingMaterial };
