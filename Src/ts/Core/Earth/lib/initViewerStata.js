...
function initViewerStata(viewer) {
    ...
    // home定位到中国范围
    // @ts-ignore
    viewer.camera.DEFAULT_VIEW_RECTANGLE = new Cesium.Cartographic(APPConfig.homeView.longitude, APPConfig.homeView.latitude, APPConfig.homeView.height);
    // 设置相机位置在中国位置
    viewer.scene.camera.setView({
        destination: Cesium.Cartesian3.fromDegrees(APPConfig.homeView.longitude, APPConfig.homeView.latitude, APPConfig.homeView.height),
        orientation: {
