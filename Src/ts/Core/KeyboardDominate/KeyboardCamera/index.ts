/****************************************************************************
 ...
 最后修改日期：2022-03-15
 ****************************************************************************/
import { Camera, Ellipsoid, Viewer } from 'cesium';
...
class KeyboardCamera {
     ...
     * @param ellipsoid
     **/
    setCamera(flags: Flags, camera: Camera, ellipsoid: Ellipsoid) {
     ...
     * @param value 布尔值
     **/
    changeFlagForKeyCode(keyCode: number, flags: Flags, value: boolean) {
        switch (keyCode) {
            case 'W'.charCodeAt(0):
