...
class VGELayer extends VGEData {
    constructor(viewer) {
        super(viewer);
    }
    async addData(resourceItem) {
    ...
    addSingleTileImagery(url, param) {
    ...
    // 添加 wmts 服务的地图
    addWebMapTileServiceImageryProvider(url, param) {
    ...
    addImageryXYZ_TMS_Provider(url, param) {
        const queryParameters = param.properties.queryParameters || {};
        const resource = new Cesium.Resource({ url, queryParameters });
        const paramDefault = {
            url: resource,
    ...
    addImageryXYZ_3857_Provider(url, param) {
        const queryParameters = param.properties.queryParameters || {};
        const resource = new Cesium.Resource({ url, queryParameters });
        ...
        if (param.properties.rectangle) {
            rectangle = new Cesium.Rectangle(angleToRadian(param.properties.rectangle.west), angleToRadian(param.properties.rectangle.south), angleToRadian(param.properties.rectangle.east), angleToRadian(param.properties.rectangle.north));
        }
    ...
    addImageryWebMercatorTilingScheme2x2_Provider(url, param) {
        const imageryProvider = new Cesium.UrlTemplateImageryProvider({
            ...param.properties,
            url: url,
            tilingScheme: new Cesium.WebMercatorTilingScheme({
    ...
    addImageryXYZ_4326_Provider(url, param) {
        const queryParameters = param.properties.queryParameters || {};
        const resource = new Cesium.Resource({ url, queryParameters });
        const imageryProvider = new Cesium.UrlTemplateImageryProvider({
            ...param.properties,
    ...
    addArcGisMapServerImagery(url, param) {
        const queryParameters = param.properties.queryParameters || {};
        const resource = new Cesium.Resource({ url, queryParameters });
    ...
    addImageryProvider(provider, resourceItem) {
