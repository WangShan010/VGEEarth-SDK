...
class VGEGLTF extends VGEData {
    ...
    async addData(sourceItem) {
        ...
        let orientation = sourceItem.properties.orientation ? sourceItem.properties.orientation : Cesium.Transforms.headingPitchRollQuaternion(position, hpr);
        let option = {
            id: sourceItem.pid,
